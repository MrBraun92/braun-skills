...
Decode:
- PSR \uc0\u8594  \u10003  Pipeline Status Report (in glossary)
- Todd \uc0\u8594  \u10003  Todd Martinez (in people/)
- Phoenix \uc0\u8594  ? Not in memory
```
...
- **Links** from tasks \uc0\u8594  add to project/people files
- **Status changes** ("launch done") \uc0\u8594  update project status, demote from CLAUDE.md
- **Relationships** ("Todd's sign-off on Maya's proposal") \uc0\u8594  cross-reference people
- **Deadlines** \uc0\u8594  add to project files
