...
\uc0\u9500 \u9472 \u9472  Cash receipts/disbursements recording
\uc0\u9500 \u9472 \u9472  Bank statement retrieval
\uc0\u9500 \u9472 \u9472  Payroll processing/accrual
\uc0\u9500 \u9472 \u9472  Fixed asset depreciation run
\uc0\u9500 \u9472 \u9472  Prepaid amortization
\uc0\u9500 \u9472 \u9472  AP accrual preparation
\uc0\u9492 \u9472 \u9472  Intercompany transaction posting

LEVEL 2 (Depends on Level 1 completion):
\uc0\u9500 \u9472 \u9472  Bank reconciliation (needs: cash entries + bank statement)
\uc0\u9500 \u9472 \u9472  Revenue recognition (needs: billing/delivery data finalized)
\uc0\u9500 \u9472 \u9472  AR subledger reconciliation (needs: all revenue/cash entries)
\uc0\u9500 \u9472 \u9472  AP subledger reconciliation (needs: all AP entries/accruals)
\uc0\u9500 \u9472 \u9472  FX revaluation (needs: all foreign currency entries posted)
\uc0\u9492 \u9472 \u9472  Remaining accrual JEs (needs: review of all source data)

LEVEL 3 (Depends on Level 2 completion):
\uc0\u9500 \u9472 \u9472  All balance sheet reconciliations (needs: all JEs posted)
\uc0\u9500 \u9472 \u9472  Intercompany reconciliation (needs: both sides posted)
\uc0\u9500 \u9472 \u9472  Adjusting entries from reconciliations
\uc0\u9492 \u9472 \u9472  Preliminary trial balance

LEVEL 4 (Depends on Level 3 completion):
\uc0\u9500 \u9472 \u9472  Tax provision (needs: pre-tax income finalized)
\uc0\u9500 \u9472 \u9472  Equity roll-forward
\uc0\u9500 \u9472 \u9472  Consolidation and eliminations
\uc0\u9500 \u9472 \u9472  Draft financial statements
\uc0\u9492 \u9472 \u9472  Preliminary flux analysis

LEVEL 5 (Depends on Level 4 completion):
\uc0\u9500 \u9472 \u9472  Management review
\uc0\u9500 \u9472 \u9472  Final adjustments
\uc0\u9500 \u9472 \u9472  Hard close / period lock
\uc0\u9500 \u9472 \u9472  Financial reporting package
\uc0\u9492 \u9472 \u9472  Forecast updates
```
...
```
Cash/AP/AR entries \uc0\u8594  Subledger reconciliations \u8594  Balance sheet recs \u8594 
  Tax provision \uc0\u8594  Draft financials \u8594  Management review \u8594  Hard close
```
