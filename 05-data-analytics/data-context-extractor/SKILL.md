...
description: Generate or improve a company-specific data analysis skill by extracting schema knowledge, metrics definitions, terminology, and query patterns from analysts. Use when setting up a warehouse-specific data skill from scratch or iteratively expanding an existing one with new domains and references.
---
...
Listen for:
- Exact formulas (ARR = monthly_revenue \'d7 12)
...
\uc0\u9500 \u9472 \u9472  SKILL.md
\uc0\u9492 \u9472 \u9472  references/
    \uc0\u9500 \u9472 \u9472  entities.md          # Entity definitions and relationships
    \uc0\u9500 \u9472 \u9472  metrics.md           # KPI calculations
    \uc0\u9500 \u9472 \u9472  tables/              # One file per domain
    \uc0\u9474    \u9500 \u9472 \u9472  [domain1].md
    \uc0\u9474    \u9492 \u9472 \u9472  [domain2].md
    \uc0\u9492 \u9472 \u9472  dashboards.json      # Optional: existing dashboards catalog
```
