...
- **todd** \uc0\u8594  Todd Martinez, Finance lead, prefers Slack
- **PSR** \uc0\u8594  Pipeline Status Report (weekly sales doc)
- **oracle** \uc0\u8594  Oracle Systems deal, not the company

## Architecture

```
CLAUDE.md          \uc0\u8592  Hot cache (~30 people, common terms)
memory/
  glossary.md      \uc0\u8592  Full decoder ring (everything)
  people/          \uc0\u8592  Complete profiles
  projects/        \uc0\u8592  Project details
  context/         \uc0\u8592  Company, teams, tools
```
...
1. Check CLAUDE.md (hot cache)
   \uc0\u8594  Todd? \u10003  Todd Martinez, Finance
   \uc0\u8594  PSR? \u10003  Pipeline Status Report
   \uc0\u8594  Phoenix? \u10003  DB migration project

2. If not found \uc0\u8594  search memory/glossary.md
   \uc0\u8594  Full glossary has everyone/everything

3. If still not found \uc0\u8594  ask user
   \uc0\u8594  "What does X mean? I'll remember it."
```
...
\uc0\u8594  Full list: memory/glossary.md, profiles: memory/people/
...
\uc0\u8594  Full glossary: memory/glossary.md
...
```
1. CLAUDE.md (hot cache)     \uc0\u8594  Check first, covers 90% of cases
2. memory/glossary.md        \uc0\u8594  Full glossary if not in hot cache
3. memory/people/, projects/ \uc0\u8594  Rich detail when needed
4. Ask user                  \uc0\u8594  Unknown term? Learn it.
```
...
CLAUDE.md lookup:
  "todd" \uc0\u8594  Todd Martinez, Finance \u10003 
  "PSR" \uc0\u8594  Pipeline Status Report \u10003 
  "oracle" \uc0\u8594  (not in hot cache)

memory/glossary.md lookup:
  "oracle" \uc0\u8594  Oracle Systems deal ($2.3M) \u10003 
...
| Historical/stale | \uc0\u10007  Remove | \u10003  Keep in memory/ |
