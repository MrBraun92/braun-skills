...
- "We use feature flags" \uc0\u8594  adds flag verification steps
- "This includes a database migration" \uc0\u8594  adds migration-specific checks
- "This is a breaking API change" \uc0\u8594  adds consumer notification steps
